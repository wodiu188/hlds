...
public class CRUDGenerate {
    public static void main(String[] args) {
        ...
        //手动配置数据源
        String url="jdbc:mysql://localhost:3306/axshare?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai";   //注意修改数据库名
        String name="root";
        String password="123456";

        //数据库表的设置
        List<String> listTable = Arrays.asList("subject");  //设置需要自动代码生成的表名
//        listTable.add("subject");
//        List<String> listTableSuffix = Arrays.asList("_b");    //设置 过滤 表的后缀
//        List<String> listTablePrefix = Arrays.asList("t_","c_"); //设置 过滤 表的后缀

        //基本信息
        String author = "wodiu";    //作者
        String parent = "com";   //父包名
        String module = "axshare";   //模块包名
